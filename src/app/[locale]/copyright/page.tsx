...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Avatar Legends: The Fighting Game Wiki',
    description: 'Copyright and intellectual property information for Avatar Legends: The Fighting Game Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Avatar Legends: The Fighting Game Wiki',
      description: 'Copyright and intellectual property information for Avatar Legends: The Fighting Game Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Avatar Legends: The Fighting Game Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Avatar Legends: The Fighting Game Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Avatar Legends: The Fighting Game Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>Avatar Legends: The Fighting Game Developers</strong> - Creators of Avatar Legends: The Fighting Game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Avatar Legends: The Fighting Game</strong> - Trademark of the game developers</li>
              <li><strong>Avatar Legends: The Fighting Game Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Avatar Legends: The Fighting Game Wiki.
            </p>
            ...
            <p>
              ...
              Avatar Legends: The Fighting Game Wiki<br />
              Email: <a href="mailto:dmca@avatar-legends-the-fighting-game.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@avatar-legends-the-fighting-game.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Avatar Legends: The Fighting Game Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Avatar Legends: The Fighting Game Wiki (avatar-legends-the-fighting-game.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@avatar-legends-the-fighting-game.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@avatar-legends-the-fighting-game.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@avatar-legends-the-fighting-game.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@avatar-legends-the-fighting-game.wiki</a>
            </p>
            <p>
