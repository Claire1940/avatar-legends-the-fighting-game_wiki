...
export async function GET() {
  const baseUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.avatar-legends-the-fighting-game.wiki'
  const siteName = process.env.NEXT_PUBLIC_SITE_NAME || 'Avatar Legends: The Fighting Game Wiki'
